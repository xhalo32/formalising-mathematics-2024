...
example : ∀ x : ℝ, ∃ y, x + y ≠ 2 := by
  intro x
  use -x + 1.999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
  norm_num
  done
